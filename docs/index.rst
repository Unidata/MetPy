...
Calendar
--------
Check out the MetPy Community Calendar below. The bi-weekly MetPy Community Dev Call is an open discussion for community
input, developer highlights and updates, and community code showcase opportunities. Stop by! Find more information in
the pinned thread in the `Announcements section <https://github.com/Unidata/MetPy/discussions/categories/announcements>`
