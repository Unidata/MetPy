...
* pythongallery_ is a collection of examples for using Python for various meteorological tasks, across many different libraries.
...
.. _pythongallery: https://unidata.github.io/python-gallery/
