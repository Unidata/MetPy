...
@pytest.mark.mpl_image_compare(tolerance=1.072 if module_version_before('matplotlib', '3.5') else 0,
                               remove_text=True)
...
@pytest.mark.mpl_image_compare(tolerance=1.215 if module_version_before('matplotlib', '3.5') else 0,
                               remove_text=True)
