...
@pytest.fixture()
def gfs_global_dataset():
    """Fixture to create dataset on GFS 0.5deg latitude_longitude grid."""
    ...
    time = xr.DataArray(
        datetime(2018, 3, 8, 0), attrs={"standard_name": "time"}
    )
    isobaric2 = xr.DataArray(
        50000.0,attrs={"units": "Pa", "long_name": "Isobaric surface", "positive": "down"}
    )

    Temperature_isobaric = xr.DataArray(
        np.array(
            [[226.72115, 226.72115, 226.72115, 226.72115,
              226.72115, 226.72115, 226.72115, 226.72115],
             [226.72115, 226.72115, 226.72115, 226.72115,
              226.72115, 226.72115, 226.72115, 226.72115],
             [226.92114, 226.92114, 226.92114, 226.92114,
              226.92114, 226.92114, 226.92114, 226.92114],
             [227.02115, 227.02115, 227.02115, 227.02115,
              227.02115, 227.02115, 227.02115, 227.02115],
             [227.02115, 227.02115, 227.02115, 227.02115,
              227.02115, 227.12114, 227.12114, 227.12114],
             [227.12114, 227.12114, 227.12114, 227.12114,
              227.12114, 227.12114, 227.12114, 227.12114],
             [227.82114, 227.82114, 227.82114, 227.82114,
              227.82114, 227.92114, 227.92114, 227.92114],
             [228.52115, 228.52115, 228.52115, 228.52115,
              228.52115, 228.52115, 228.52115, 228.52115]]
        ),
        coords=(lat, lon),
    ...
    u_component_of_wind_isobaric = xr.DataArray(
        np.array(
            [[-4.395503, -4.385503, -4.375503, -4.365503,
              -4.345503, -4.335503, -4.325503, -4.305503],
             [-5.635503, -5.605503, -5.565503, -5.535503,
              -5.505503, -5.475503, -5.445503, -5.415503],
             [-7.035503, -6.985503, -6.925503, -6.875503,
              -6.825503, -6.765503, -6.715503, -6.665503],
             [-8.325503, -8.265503, -8.195503, -8.135503,
              -8.065503, -8.005503, -7.935503, -7.875503],
             [-7.225503, -7.165503, -7.115503, -7.065503,
              -7.015503, -6.955503, -6.905503, -6.855503],
             [-4.915503, -4.855503, -4.795503, -4.735503,
              -4.685503, -4.625503, -4.565503, -4.505503],
             [-1.305503, -1.245503, -1.185503, -1.115503,
              -1.065503, -0.995503, -0.945503, -0.885503],
             [ 2.074497,  2.104497,  2.144497,  2.174497,
               2.214497,  2.244497,  2.274497,  2.304497]]
        ),
        coords=(lat, lon),
        name="u-component_of_wind-isobaric",
        attrs={
    ...
    v_component_of_wind_isobaric = xr.DataArray(
        np.array(
            [[1.397629, 1.437629, 1.477629, 1.507629,
              1.547629, 1.587629, 1.627629, 1.667629],
             [2.377629, 2.417629, 2.457629, 2.497629,
              2.537629, 2.567629, 2.607629, 2.647629],
             [3.347629, 3.38763 , 3.437629, 3.487629,
              3.527629, 3.577629, 3.617629, 3.657629],
             [4.417629, 4.477629, 4.547629, 4.61763 ,
              4.677629, 4.737629, 4.80763 , 4.86763 ],
             [4.78763 , 4.857629, 4.927629, 4.997629,
              5.05763 , 5.127629, 5.187629, 5.247629],
             [4.727629, 4.78763 , 4.857629, 4.927629,
              4.987629, 5.047629, 5.107629, 5.167629],
             [4.61763 , 4.707629, 4.797629, 4.877629,
              4.967629, 5.047629, 5.127629, 5.207629],
             [5.047629, 5.147629, 5.237629, 5.337629,
              5.427629, 5.527629, 5.607629, 5.697629]]
        ),
        coords=(lat, lon),
        name="v-component_of_wind_isobaric",
        attrs={
    ...
    return xr.merge(
        [Temperature_isobaric, u_component_of_wind_isobaric, v_component_of_wind_isobaric],
        combine_attrs="drop_conflicts",
    ).assign_coords({"time": time, "isobaric2": isobaric2})
...
def test_divergence_geographic():
    ...
    a = np.arange(4)[None, :]
    u = v = np.r_[a, a, a] * units('m/s')
    vort = divergence(u, v, longitude=lons, latitude=lats, crs=crs)
