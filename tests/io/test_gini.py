...
raw_gini_info = [
    (
        ...
        make_pdb(
            source=1,
            creating_entity="GOES-15",
            sector_id="West CONUS",
            channel="WV (6.5/6.7 micron)",
            num_records=1280,
            record_len=1100,
            datetime=datetime(2015, 12, 8, 22, 0, 19),
            projection=GiniProjection.lambert_conformal,
            nx=1100,
            ny=1280,
            la1=12.19,
            lo1=-133.4588,
        ...
        make_pdb2(
            scanning_mode=[False, False, False],
            lat_in=25.0,
            resolution=4,
            compression=0,
            version=1,
        ...
        GiniFile.lc_ps_fmt.make_tuple(
            reserved=0, lov=-95.0, dx=4.0635, dy=4.0635, proj_center=0
        ),
    ),
    (
        ...
        make_pdb(
            source=1,
            creating_entity="GOES-15",
            sector_id="Alaska Regional",
            channel="IR (3.9 micron)",
            num_records=408,
            record_len=576,
            datetime=datetime(2016, 4, 8, 14, 45, 20),
            projection=GiniProjection.polar_stereographic,
            nx=576,
            ny=408,
            la1=42.0846,
            lo1=-175.641,
        ...
        GiniFile.lc_ps_fmt.make_tuple(
            reserved=0, lov=210.0, dx=7.9375, dy=7.9375, proj_center=0
        ),
    ),
    (
        ...
        make_pdb(
            source=1,
            creating_entity="GOES-15",
            sector_id="Hawaii Regional",
            channel="IR (3.9 micron)",
            num_records=520,
            record_len=560,
            datetime=datetime(2016, 6, 16, 17, 15, 18),
            projection=GiniProjection.mercator,
            nx=560,
            ny=520,
            la1=9.343,
            lo1=-167.315,
        ...
        GiniFile.mercator_fmt.make_tuple(resolution=0, la2=28.0922, lo2=-145.878, di=0, dj=0),
    ),
]


@pytest.mark.parametrize(
    "filename,pdb,pdb2,proj_info", raw_gini_info, ids=["LCC", "Stereographic", "Mercator"]
)
...
gini_dataset_info = [
    (
        "WEST-CONUS_4km_WV_20151208_2200.gini",
        (-4226066.37649, 239720.12351, -832700.70519, 4364515.79481),
        "WV",
        {
    ...
    (
        "AK-REGIONAL_8km_3.9_20160408_1445.gini",
        (-2286001.13195, 2278061.36805, -4762503.5992, -1531941.0992),
        "IR",
        {
    ...
    (
        "HI-REGIONAL_4km_3.9_20160616_1715.gini",
        (0.0, 2236000.0, 980627.44738, 3056627.44738),
        "IR",
        {
            "grid_mapping_name": "mercator",
            "standard_parallel": 20.0,
            "earth_radius": 6371200.0,
            "latitude_of_projection_origin": 9.343,
...
@pytest.mark.parametrize(
    "filename,bounds,data_var,proj_attrs,image,dt",
    gini_dataset_info,
