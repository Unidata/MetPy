...
from metpy.io import (parse_metar_to_named_tuple, parse_metar_to_pandas, station_info,
                      text_file_parse)


def test_station_id_not_in_dictionary():
    """Test for when the METAR does not correspond to a station in the dictionary."""
    df = parse_metar_to_pandas('METAR KLBG 261155Z AUTO 00000KT 10SM CLR 05/00 A3001 RMK '
                               'AO2=')
...
def test_broken_clouds():
    ...
    df = parse_metar_to_pandas('METAR KLOT 261155Z AUTO 00000KT 10SM BKN100 05/00 A3001 RMK '
                               'AO2=')
...
def test_few_clouds_():
    ...
    df = parse_metar_to_pandas('METAR KMKE 261155Z AUTO /////KT 10SM FEW100 05/00 A3001 RMK '
                               'AO2=')
...
def test_all_weather_given():
    ...
    df = parse_metar_to_pandas('METAR RJOI 261155Z 00000KT 4000 -SHRA BR VCSH BKN009 BKN015 '
                               'OVC030 OVC040 22/21 A2987 RMK SHRAB35E44 SLP114 VCSH S-NW '
                               'P0000 60021 70021 T02220206 10256 20211 55000=')
...
def test_missing_temp_dewp():
    ...
    df = parse_metar_to_pandas('KIOW 011152Z AUTO A3006 RMK AO2 SLPNO 70020 51013 PWINO=')
...
def test_missing_values():
    ...
    df = parse_metar_to_pandas('METAR KBOU 011152Z AUTO 02006KT //// // ////// 42/02 Q1004=')
...
def test_vertical_vis():
    ...
    df = parse_metar_to_pandas('KSLK 011151Z AUTO 21005KT 1/4SM FG VV002 14/13 A1013 RMK '
...
def test_date_time_given():
    ...
    df = parse_metar_to_pandas('K6B0 261200Z AUTO 00000KT 10SM CLR 20/M17 A3002 RMK AO2 '
...
def test_named_tuple_test1():
    ...
    df = parse_metar_to_named_tuple('KDEN 012153Z 09010KT 10SM FEW060 BKN110 BKN220 27/13 '
                                    'A3010 RMK AO2 LTG DSNT SW AND W SLP114 OCNL LTGICCG '
                                    'DSNT SW CB DSNT SW MOV E T02670128', station_info)
