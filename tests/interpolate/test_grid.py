...
boundary_types = [{"west": 80.0, "south": 140.0, "east": 980.0, "north": 980.0}, None]
...
def test_interpolate_to_grid(method, test_coords, boundary_coords):
    ...
    z = np.array([0.064, 4.489, 6.241, 0.1, 2.704, 2.809, 9.604, 1.156, 0.225, 3.364])
...
def test_interpolate_to_isosurface_from_below():
    ...
    thta = np.array(
        [
            [
                ...
                [340.0, 360.0, 380.0, 400.0, 420.0],
                [350.0, 370.0, 390.0, 410.0, 430.0],
                [360.0, 380.0, 400.0, 420.0, 440.0],
                [370.0, 390.0, 410.0, 430.0, 450.0],
            ],
            [
    ...
    truth = np.array(
        [
            [330.0, 350.0, 370.0, 385.0, 400.0],
            [340.0, 359.0, 374.0, 389.0, 404.0],
            [348.0, 363.0, 378.0, 393.0, 410.0],
            [352.0, 367.0, 382.0, 400.0, 420.0],
            [356.0, 371.0, 390.0, 410.0, 430.0],
        ]
    )
