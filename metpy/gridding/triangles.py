...
def dist_2(x0, y0, x1, y1):
    r"""Returns the squared distance between two points.
...
def distance(p0, p1):
    r"""Returns the distance between two points.
...
def circumcircle_radius_2(pt0, pt1, pt2):
    r"""Calculates and returns the squared radius of a
...
def circumcircle_radius(pt0, pt1, pt2):
    r"""Calculates and returns the radius of a given
...
def circumcenter(pt0, pt1, pt2):
    r"""Calculates and returns the circumcenter of
...
def find_natural_neighbors(tri, grid_points):
    r"""Returns the natural neighbor triangles for
...
def find_nn_triangles_point(tri, cur_tri, point):
    r"""Returns the natural neighbors of a triangle
...
def find_local_boundary(tri, triangles):
    r"""Finds and returns the outside edges of a collection
