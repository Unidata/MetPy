...
def NN_resample_1d(a,centers):
    
    """Helper function that returns one-dimensional nearest-neighbor indexes based on user-specified centers.
    ----------
    a : array-like
        1-dimensional array of numeric values from which to extract indexes of nearest-neighbors
    centers : array-like
