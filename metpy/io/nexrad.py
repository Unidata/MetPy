...
class Level3File(object):
    ...
    prod_spec_map = {16  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3), ('calib_const', float_elem(7, 8))),
                     ...
                     28  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3)),
                     30  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3)),
                     32  : (('max', 3), ('avg_time', date_elem(4, 5)), ('compression', 7),
                            ('uncompressed_size', combine_elem(8, 9))),
                     34  : (('clutter_bitmap', 0), ('cmd_map', 1), ('bypass_map_date', date_elem(4, 5)),
                            ('notchwidth_map_date', date_elem(6, 7))),
                     36  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3), ('calib_const', float_elem(7, 8))),
                     37  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3), ('calib_const', float_elem(7, 8))),
                     38  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3), ('calib_const', float_elem(7, 8))),
                     ...
                     62  : (),
                     65  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3),
                            ('layer_bottom', scaled_elem(4, 1000.)), ('layer_top', scaled_elem(5, 1000.)),
                            ('calib_const', float_elem(7, 8))),
                     66  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3),
                            ('layer_bottom', scaled_elem(4, 1000.)), ('layer_top', scaled_elem(5, 1000.)),
                            ('calib_const', float_elem(7, 8))),
                     67  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3),
                            ('layer_bottom', scaled_elem(4, 1000.)), ('layer_top', scaled_elem(5, 1000.)),
                            ('calib_const', float_elem(7, 8))),
                     74  : (),
                     ...
                     81  : (('max_rainfall', scaled_elem(3, 0.001)), ('bias', scaled_elem(4, 0.01)),
                            ('gr_pairs', scaled_elem(5, 0.01)), ('rainfall_end', date_elem(6, 7))),
                     82  : (),
                     90  : (('el_angle', scaled_elem(2, 0.1)), ('max', 3),
                            ('layer_bottom', scaled_elem(4, 1000.)), ('layer_top', scaled_elem(5, 1000.)),
                            ('calib_const', float_elem(7, 8))),
                     ...
                     152 : (('compression', 7), ('uncompressed_size', combine_elem(8, 9))),
