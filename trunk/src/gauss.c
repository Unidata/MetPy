/* Generated by Cython 0.11.3 on Thu Oct  1 12:02:09 2009 */
...
typedef __pyx_t_5numpy_float_t __pyx_t_5gauss_DTYPE_t;
...
/* Module declarations from gauss */

static __pyx_t_5gauss_DTYPE_t __pyx_k_31;
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t = { "gauss.DTYPE_t", NULL, sizeof(__pyx_t_5gauss_DTYPE_t), 'R' };
#define __Pyx_MODULE_NAME "gauss"
int __pyx_module_is_main_gauss = 0;

/* Implementation of gauss */
...
static PyObject *__pyx_pf_5gauss_gauss_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_5gauss_gauss_filter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_x = 0;
  PyArrayObject *__pyx_v_y = 0;
  PyArrayObject *__pyx_v_var = 0;
  __pyx_t_5gauss_DTYPE_t __pyx_v_sigmax;
  __pyx_t_5gauss_DTYPE_t __pyx_v_sigmay;
  __pyx_t_5gauss_DTYPE_t __pyx_v_masked_value;
  __pyx_t_5gauss_DTYPE_t __pyx_v_min_weight;
  unsigned int __pyx_v_xloc;
  unsigned int __pyx_v_yloc;
  unsigned int __pyx_v_xi;
  unsigned int __pyx_v_yi;
  __pyx_t_5gauss_DTYPE_t __pyx_v_xdenom;
  __pyx_t_5gauss_DTYPE_t __pyx_v_ydenom;
  __pyx_t_5gauss_DTYPE_t __pyx_v_weighted_sum;
  __pyx_t_5gauss_DTYPE_t __pyx_v_totalw;
  __pyx_t_5gauss_DTYPE_t __pyx_v_weights;
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (values[6]) {
      ...
      __pyx_v_min_weight = ((__pyx_t_5gauss_DTYPE_t)0.0001);
    }
  } else {
    __pyx_v_masked_value = __pyx_k_31;
    __pyx_v_min_weight = ((__pyx_t_5gauss_DTYPE_t)0.0001);
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("gauss.gauss_filter");
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_var), __pyx_ptype_5numpy_ndarray, 1, "var", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x = __pyx_bstruct_x.strides[0];
  __pyx_bshape_0_x = __pyx_bstruct_x.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_y, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_y = __pyx_bstruct_y.strides[0];
  __pyx_bshape_0_y = __pyx_bstruct_y.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_var, (PyObject*)__pyx_v_var, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_var_fil, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_xweight, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_yweight, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5gauss_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_xweight.buf, __pyx_t_12, __pyx_bstride_0_xweight, __pyx_t_13, __pyx_bstride_1_xweight) = exp((__pyx_v_xdenom * pow(((*__Pyx_BufPtrStrided1d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_x.buf, __pyx_t_10, __pyx_bstride_0_x)) - (*__Pyx_BufPtrStrided1d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_x.buf, __pyx_t_11, __pyx_bstride_0_x))), 2)));
    }
  }
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_yweight.buf, __pyx_t_16, __pyx_bstride_0_yweight, __pyx_t_17, __pyx_bstride_1_yweight) = exp((__pyx_v_ydenom * pow(((*__Pyx_BufPtrStrided1d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_y.buf, __pyx_t_14, __pyx_bstride_0_y)) - (*__Pyx_BufPtrStrided1d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_y.buf, __pyx_t_15, __pyx_bstride_0_y))), 2)));
    }
  }
 ...
 */
      ...
      __pyx_t_20 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_var.buf, __pyx_t_18, __pyx_bstride_0_var, __pyx_t_19, __pyx_bstride_1_var)) != __pyx_v_masked_value);
      if (__pyx_t_20) {
 ...
 */
            ...
            __pyx_t_20 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_var.buf, __pyx_t_23, __pyx_bstride_0_var, __pyx_t_24, __pyx_bstride_1_var)) != __pyx_v_masked_value);
            if (__pyx_t_20) {
 ...
 */
              ...
              __pyx_v_weights = ((*__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_xweight.buf, __pyx_t_25, __pyx_bstride_0_xweight, __pyx_t_26, __pyx_bstride_1_xweight)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_yweight.buf, __pyx_t_27, __pyx_bstride_0_yweight, __pyx_t_28, __pyx_bstride_1_yweight)));
 ...
 */
                ...
                __pyx_v_weighted_sum += ((*__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_var.buf, __pyx_t_29, __pyx_bstride_0_var, __pyx_t_30, __pyx_bstride_1_var)) * __pyx_v_weights);
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_var_fil.buf, __pyx_t_21, __pyx_bstride_0_var_fil, __pyx_t_22, __pyx_bstride_1_var_fil) = (__pyx_v_weighted_sum / __pyx_v_totalw);
        goto __pyx_L25;
      }
      /*else*/ {
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_5gauss_DTYPE_t *, __pyx_bstruct_var_fil.buf, __pyx_t_31, __pyx_bstride_0_var_fil, __pyx_t_32, __pyx_bstride_1_var_fil) = __pyx_v_masked_value;
      }
      __pyx_L25:;
    }
  }
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("gauss_filter"), (PyCFunction)__pyx_pf_5gauss_gauss_filter, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgauss(void); /*proto*/
PyMODINIT_FUNC initgauss(void)
#else
PyMODINIT_FUNC PyInit_gauss(void); /*proto*/
...
#endif
{
  ...
  __pyx_refchk = __Pyx_Refnanny->NewContext("PyMODINIT_FUNC PyInit_gauss(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("gauss"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init gauss");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gauss");
  }
  __pyx_L0:;
  __Pyx_FinishRefcountContext();
  #if PY_MAJOR_VERSION < 3
