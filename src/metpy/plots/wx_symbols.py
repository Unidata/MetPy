...
with exporter:
    ...
    wx_code_map = {'': 0, 'M': 0, 'TSNO': 0, 'VA': 4, 'FU': 4,
                   ...
                   'VCTSRA': 63, 'RA': 63, 'RABR': 63, 'RAFG': 63, 'VCRA': 63,
                   ...
                   '-TSRASN': 95, 'TSRASN': 95, '-TSSNRA': 95, 'TSSNRA': 95,
                   '-TSRA': 1095, 'TSRA': 1095, '-TSDZ': 1095,
                   'TSPL': 2095, '-TSSN': 2095, '-TSPL': 2095, 'TSSN': 2095,
                   'TSPLSN': 2095, 'TSSNPL': 2095, '-TSSNPL': 2095,
                   '-TSRAGR': 96, 'TSRAGS': 96, 'TSRAGR': 96, 'TSGS': 96, 'TSGR': 96,
                   '+TSFZRAPL': 97, '+TSRA': 1097, '+TSFZRA': 1097, '+TSSN': 2097,
                   '+TSPL': 2097, '+TSPLSN': 2097, 'TSSA': 98, 'TSDS': 98,
                   'TSDU': 98, '+TSGS': 99, '+TSGR': 99, '+TSRAGR': 99,
