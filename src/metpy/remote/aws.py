...
class AWSProduct:
    ...
    def parse(self):
        """Parse the product into a usable Python object.
...
class S3DataStore:
    ...
    def objects(self, prefix):
        ...
        Iterator of `botocore.client.Object`
            Objects matching matching the given prefix.
    ...
    def _closest_result(self, it, dt):
        ...
        min_obj = min(it, key=lambda o: abs((self.dt_from_key(o.key) - dt).total_seconds()))
    ...
    * Feature detection (e.g. tornadoes, mesocyclones, hail)
    ...
    def get_product(self, site, prod_id, dt=None):
        ...
        dt : `datetime.datetime`, optional
            The desired date/time for the product; the product closest matching in time will
